...
const HelperModalEdit = ({ open, handleClose, editData }) => {
  ...
  const handleFormValues = (event) => {
    ...
    if (name === "LowStockWarning") {
      setFormValues({
        ...formValues,
        LowStockWarning: !formValues.LowStockWarning,
        LowStockUnit: !formValues.LowStockWarning
          ? ""
          : formValues.LowStockUnit,
      });
    } else if (name === "InclusiveOfTax") {
      setFormValues({
        ...formValues,
        InclusiveOfTax: !formValues.InclusiveOfTax,
      });
    } else {
                ...
                >
                  ...
                  >
                    <TextField
                      ...
                      helperText={
                        !formError.Category ? null : formError.Category
                      }
                    >
                  ...
                  <TextField
                    ...
                    helperText={
                      !formError.Description ? null : formError.Description
                    }
                  />
                </Box>
              </DialogContent>
                ...
                <Grid container spacing={2} mt={1}>
                  ...
                  <Grid item sm={12} md={6}>
                    <TextField
                      ...
                      name="AsOfDate"
                      onChange={handleFormValues}
                      value={formValues?.AsOfDate?.slice(0, 10)}
                      error={!formError.AsOfDate ? false : true}
                      helperText={
                        !formError.AsOfDate ? null : formError.AsOfDate
                      }
                      disabled
                    />
                  </Grid>
                  <Grid item sm={12} display="flex" gap="20px">
                    <FormControlLabel
                      ...
                      control={
                        <Switch
                          ...
                          onChange={handleFormValues}
                          value={formValues.LowStockWarning}
                        />
                      }
                    ...
                    {formValues.LowStockWarning ? (
                      <TextField
                        ...
                        name="LowStockUnit"
                        onChange={handleFormValues}
                        value={formValues.LowStockUnit}
                        error={
                          !formError.LowStockUnit && formValues.LowStockWarning
                            ? false
                            : true
                        }
                        helperText={
                ...
                <Grid container spacing={2} mt={1}>
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Switch
                          name="InclusiveOfTax"
                          onChange={handleFormValues}
                          value={formValues.InclusiveOfTax}
                        />
                      }
                  ...
                  <Grid item sm={12} md={6}>
                    ...
                    >
                      ...
                      <MenuItem value="7.5">VAT @ 7.5%</MenuItem>
                    </TextField>
                  </Grid>
                </Grid>
              </DialogContent>
...
export default HelperModalEdit;
